...
A generic Swift library and CLI for inspecting DocC-generated JSON documentation sites and repo examples.

## Overview

`smith-doc-inspector` provides tools to fetch, parse, and extract structured data from any website hosted using Apple's DocC (Documentation Compiler), plus repo example discovery. It generalizes the logic previously locked inside specialized tools, making it available for any Swift tooling needs.
...
- **Standalone CLI**: `smith-doc-inspector` command line tool for quick inspection.
...
```swift
.package(url: "https://github.com/smith-tools/smith-doc-inspector", from: "1.0.0")
```
...
.build/release/smith-doc-inspector docs https://developer.apple.com/documentation/swiftui
```
...
# Find example files in a repo (GitHub URL or package name)
smith-doc-inspector examples swift-nio

# Alias (legacy)
smith-doc-inspector extract https://developer.apple.com/documentation/swiftui
```
