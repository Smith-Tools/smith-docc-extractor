...
/// Generic Swift representation of DocC RenderNode JSON schema.
/// Based on Apple's DocC documentation format: https://github.com/apple/swift-docc-render-artifact
/// Originally ported from sosumi.ai TypeScript implementation.
...
public struct VariantTrait: Codable, Sendable {
...
public struct AvailabilityInfo: Codable, Sendable {
    public let name: String?
...
public struct DocumentationPlatform: Codable, Sendable {
    public let name: String?
...
public struct CustomMetadataValue: Codable, Sendable {
...
private enum AnyCodingValue: Codable, Sendable {
    case string(String)
    case int(Int)
    case double(Double)
    case bool(Bool)
...
public struct Hierarchy: Codable, Sendable {
...
/// Root type representing DocC documentation JSON response (RenderNode)
public struct DocCRenderNode: Codable, Sendable {
...
public struct DocCSearchResult: Codable, Hashable, Sendable {
    public let title: String
    public let url: String
    public let type: String
...
/// Framework documentation index response (useful for discovery)
public struct FrameworkIndex: Codable, Sendable {
    public let name: String
    public let url: String
    public let kind: String
    public let role: String
